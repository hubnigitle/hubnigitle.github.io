...
const objects = [
  {
    id: 'card_id_1',
    projectName: 'L&H Store',
    detailsOne: 'Handphone and Laptop e-commerce catalog application',
    detailsTwo: '',
    year: '2025',
    image: 'images/new/lhstore.jpg',
    alt: 'image',
    paragraphShort: 'Simple app to manage your products and maintain them',
    description: "This project is an application that can display a catalog of products available in the store, and can search for items by name and category. The application can also display the calculation of the total number of products available, as well as perform item edits, deletions, and additions. This application uses a mock API for the displayed data.",
    tools: ['Kotlin', 'Retrofit', 'Android Studio'],
    toolsTwo: ['github', 'ruby', 'bootstraps'],
    submitButton: 'work_section_buttons',
    liveLink: 'https://drive.google.com/file/d/1Ym9r6RFYfxWLEgD5Lj8vyQ4JSO53kwsu/view?usp=sharing',
    sourceLink: 'https://github.com/hubnigitle/LH_store',
  },
  {
    id: 'card_id_2',
                   ...
                   <div class="pop_skills_button">
                    ...
                    <div class="popup_button">
                      <button class="live-btn">
                        <a href="${object.liveLink}" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: inherit;">See live <img src="" alt=""/></a>
                      <img src="" alt=""/></button>
                      <button class="source-btn" type="button">
                        <a href="${object.sourceLink}" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: inherit;">See source <img src="" alt=""/></a>
                      </button>
                    </div>
                    <div class="popup_button_red">
